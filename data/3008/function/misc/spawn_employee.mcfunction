...
execute if score temp server matches 07 run execute in 3008:infinite_ikea run summon piglin ~ ~200 ~ {Tags:["game", "spawning"], attributes: [{id: "minecraft:scale", base: 0.5d}]}
execute if score temp server matches 08 run execute in 3008:infinite_ikea run summon piglin ~ ~200 ~ {Tags:["game", "spawning"], attributes: [{id: "minecraft:scale", base: 0.9d}]}
execute if score temp server matches 09 run execute in 3008:infinite_ikea run summon piglin ~ ~200 ~ {Tags:["game", "spawning"], attributes: [{id: "minecraft:scale", base: 0.95d}]}
...
execute if score temp server matches 11 run execute in 3008:infinite_ikea run summon piglin ~ ~200 ~ {Tags:["game", "spawning"], attributes: [{id: "minecraft:scale", base: 1.05d}]}
