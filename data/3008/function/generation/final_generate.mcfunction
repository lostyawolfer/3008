...
execute as @a at @s run playsound 3008:loading master @a ~ ~ ~ 1 1 1
...
execute in 3008:infinite_ikea positioned 0 0 0 run function 3008:generation/misc/generate_matrix {length: 50, width: 51}
