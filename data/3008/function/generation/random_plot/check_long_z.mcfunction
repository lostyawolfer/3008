...
execute if score temp-30% server matches 5 if score temp-3% server matches 5 run return 2
...
execute if score temp-30% server matches 2..5 if score temp-3% server matches 5 run return run function 3008:generation/random_plot/default_plot
