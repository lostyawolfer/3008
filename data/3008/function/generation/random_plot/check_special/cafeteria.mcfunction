...
execute if score temp-3% server matches 3..5 if score temp-30% server matches 5 run return run function 3008:generation/random_plot/default_plot
execute if score temp-3% server matches 4 if score temp-30% server matches 4 run return run function 3008:generation/random_plot/default_plot
