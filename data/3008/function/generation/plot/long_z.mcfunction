...
$execute as @e[type=armor_stand, tag=generating] at @s run place template 3008:plots/long_z/$(plot)_part_1 ~ ~-1 ~
$execute as @e[type=armor_stand, tag=generating] at @s run place template 3008:plots/long_z/$(plot)_part_2 ~ ~-1 ~32
