...
execute if score temp-1 server matches 0.. as @e[type=armor_stand, tag=generating2] at @s run function 3008:generation/generate_line {size: 0, pillars: 0}
...
execute if score temp-10 server matches 0.. as @e[type=armor_stand, tag=generating3] at @s run function 3008:generation/generate_matrix {length: 0, width: 0}
