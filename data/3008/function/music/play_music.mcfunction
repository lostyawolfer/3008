...
execute unless score @s music.current_song = @s music.previous_song if score @s music.time matches 1.. unless score @s music.previous_song matches 11..15 run scoreboard players set @s music.time 0
execute unless score @s music.current_song = @s music.previous_song if score @s music.time matches 1.. if score @s music.previous_song matches 11..15 run scoreboard players set @s music.time -1
...
execute if score @s music.current_song matches 1.. run stopsound @s music
...
function 3008:music/check_music_macro {id: 15, volume: .3, name: shattered_reality}
