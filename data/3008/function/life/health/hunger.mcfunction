...
execute if score @s hunger.minecraftlike matches 20.. if entity @s[tag=regenerating] run scoreboard players remove @s health.regen_timer 6
execute if score @s hunger.minecraftlike matches 20.. if entity @s[tag=regenerating] run scoreboard players remove @s hunger 7
...
execute if score @s hunger.minecraftlike matches 19.. if entity @s[tag=regenerating] run scoreboard players remove @s hunger 5
