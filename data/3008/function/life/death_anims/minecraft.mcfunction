...
execute if score @s health.death_anim matches 1 if score temp server matches 2 run tellraw @a [{"translate": "Somehow, ", "color": "red"}, {"selector": "@s", "color": "red"}, {"translate": " has died. Well... At least Minecraft said so.", "color": "red"}]
