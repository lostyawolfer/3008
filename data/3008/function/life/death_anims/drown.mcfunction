...
execute if score @s health.death_anim matches 1 if score temp server matches 1 run tellraw @a [{"selector": "@s", "color": "red"}, {"translate": " drowned", "color": "red"}]
execute if score @s health.death_anim matches 1 if score temp server matches 2 run tellraw @a [{"selector": "@s", "color": "red"}, {"translate": " forgot to breathe", "color": "red"}]
execute if score @s health.death_anim matches 1 if score temp server matches 3 run tellraw @a [{"translate": "Breathe, ", "color": "red"}, {"selector": "@s", "color": "red"}, "! BREATHE!"]
execute if score @s health.death_anim matches 1 if score temp server matches 4 run tellraw @a [{"selector": "@s", "color": "red"}, {"translate": " got water in their lungs", "color": "red"}]
